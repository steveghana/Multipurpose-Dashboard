...
export const GridOrderImage: React.FC<img> = ({ order }) => (
  <div>
    <img
...
export const GridOrderStatus: React.FC<orderStatus> = ({
  StatusBg,
  Status,
}) => (
  <button
...
export const GridEmployeeProfile: React.FC<emprofile> = ({
  employeeImage,
  name,
}) => {
  return (
...
export const GridEmployeeCountry: React.FC<countryImg> = ({ country }) => (
  <div
    className=""
    style={{
      display: "flex",
...
interface customerImg {
  CustomerImage: string;
  CustomerName: string;
  CustomerEmail: string;
}
export const CustomerGridImage: React.FC<customerImg> = ({
  CustomerImage,
  CustomerName,
  CustomerEmail,
}) => (
  ...
  >
    <img
      style={{ borderRadius: "50%", width: "49px", height: "49px" }}
      src={CustomerImage}
      alt="employee"
    />
...
export const CustomerGridStatus: React.FC<customerStatus> = ({
  StatusBg,
  Status,
}) => (
  <div
...
export const employeesGrid = [
  ...
  // { field: "Name", headerText: "", width: "0px", textAlign: "Center" },
  {
    field: "Title",
